...
function tipsWindown(title,content,width,height,drag,time,showbg,cssName,backcall) {
	...
	if(showWindown == true) {
		var simpleWindown_html = new String;
			...
			if (time != "") { simpleWindown_html += "<div id=\"windown-title\"><div class='float_right align_center clear' style=\"height: 20px; width: 100px; background-color: #CCC; margin: 5px 0px;\" id=\"cc\"></div></div>"; }
			else { simpleWindown_html += "<div id=\"windown-title\"><h2></h2><span id=\"windown-close\">关闭</span></div>"; }			
