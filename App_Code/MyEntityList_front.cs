...
using System.Text;
using System.Web.UI;
using DmFramework.Collections;
using DmFramework.Data.CommonEntity;
using DmFramework.Web;
using DmFramework.Data;
using DmFramework.WebControls;

/// <summary>
/// MyEntityList_front 的摘要说明
/// </summary>
public class MyEntityList_front : Page
{
	#region 管理页控制器
...
public class MyEntityList_front<TEntity> : MyEntityList_front where TEntity : Entity<TEntity>, new()
{
	/// <summary>实体类</summary>
