...
namespace Jetso.Data
{
    ...
    public partial class Order : Entity<Order>
    {
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(Order).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new Order();
        //    entity.MemberId = 0;
        //    entity.OrderNo = 0;
        //    entity.ReceiverEmail = "abc";
        //    entity.McGross = "abc";
        //    entity.PaymentStatus = "abc";
        //    entity.McCurrency = System.Byte[];
        //    entity.Insert();

        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(Order).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该Order所对应的member</summary>
        [XmlIgnore]
        ...
        /// <summary>该Order所对应的member姓名</summary>
        [XmlIgnore]
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Order FindByItemName(String ItemName)
        {
          if (Meta.Count >= 1000)
            return Find(_.ItemName, ItemName);
          else // 实体缓存
            return Meta.Cache.Entities.Find(_.ItemName, ItemName);
          // 单对象缓存
          //return Meta.SingleCache[id];
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Order> FindAllByMemberId(Int32 memberid)
        {
            if (Meta.Count >= 1000)
