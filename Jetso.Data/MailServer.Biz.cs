...
{
    /// <summary></summary>
    public partial class MailServer : Entity<MailServer>
    {
        #region 对象操作﻿
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(MailServer).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new MailServer();
        //    entity.server = "abc";
        //    entity.port = "abc";
        //    entity.Insert();

        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(MailServer).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static MailServer FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<MailServer> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
