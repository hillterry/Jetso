...
{
    /// <summary></summary>
    public partial class system : Entity<system>
    {
        #region 对象操作﻿
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(system).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new system();
        //    entity.email = "abc";
        //    entity.Insert();

        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(system).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static system FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<system> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
