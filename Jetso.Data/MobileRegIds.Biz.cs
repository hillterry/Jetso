...
{
    /// <summary></summary>
    public partial class MobileRegIds : Entity<MobileRegIds>
    {
        #region 对象操作﻿
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(MobileRegIds).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new MobileRegIds();
        //    entity.RegsId = 0;
        //    entity.User = 0;
        //    entity.Insert();

        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(MobileRegIds).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static MobileRegIds FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<MobileRegIds> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
