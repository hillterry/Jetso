...
namespace Jesto.Data
{
    ...
    public partial class Address : Entity<Address>
    {
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(Address).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new Address();
        //    entity.MemberID = 0;
        //    entity.Addressee = "abc";
        //    entity.Addr = "abc";
        //    entity.Phone = "abc";
        //    entity.MobilePhone = "abc";
        //    entity.IsDefaoult = true;
        //    entity.Insert();

        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(Address).Name, Meta.Table.DataTable.DisplayName);
        //}
			...
			//	{
			//if (members != null) members.Delete();
        ...
        /// <summary>该Address所对应的member</summary>
        [XmlIgnore]
        ...
        /// <summary>该Address所对应的member姓名</summary>
        [XmlIgnore]
        ...
        public static EntityList<Address> FindAllByMemberID(Int32 memberid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Address FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<Address> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
