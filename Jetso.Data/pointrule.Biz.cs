...
{
	/// <summary></summary>
	public partial class pointrule : Entity<pointrule>
	{
		#region 对象操作﻿
		...
		//    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(pointrule).Name, Meta.Table.DataTable.DisplayName);

		//    var entity = new pointrule();
		//    entity.regpoint = 0;
		//    entity.loginpoint = 0;
		//    entity.intropoint = 0;
		//    entity.introsucpoint = 0;
		//    entity.friendpoint = 0;
		//    entity.facebookpoint = 0;
		//    entity.Insert();

		//    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(pointrule).Name, Meta.Table.DataTable.DisplayName);
		//}
		...
		public static pointrule FindByid(Int32 __id)
		{
			if (Meta.Count >= 1000)
		...
		//public static EntityList<pointrule> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		//{
