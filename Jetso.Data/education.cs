...
namespace Jetso.Data
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("PK__educatio__3214EC07145C0A3F", true, "Id")]
    [BindTable("education", Description = "", ConnName = "CommonBilling", DbType = DatabaseType.SqlServer)]
    ...
    /// <summary>接口</summary>
    public partial interface Ieducation
    {
        #region 属性
        /// <summary></summary>
        Int32 Id { get; set; }
