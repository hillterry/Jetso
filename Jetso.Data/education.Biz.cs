...
{
    /// <summary></summary>
    public partial class education : Entity<education>
    {
        #region 对象操作﻿
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(education).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(education).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static education FindById(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<education> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
