...
{
    /// <summary></summary>
    public partial class couponshare : Entity<couponshare>
    {
        #region 对象操作﻿
        ...
        //    HmTrace.WriteDebug("开始初始化{0}[{1}]数据……", typeof(couponshare).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new couponshare();
        //    entity.ID = 0;
        //    entity.memberId = 0;
        //    entity.productId = 0;
        //    entity.ShareTimes = 0;
        ...
        //    HmTrace.WriteDebug("完成初始化{0}[{1}]数据！", typeof(couponshare).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该couponshare所对应的member</summary>
        [XmlIgnore]
        ...
        /// <summary>该couponshare所对应的member姓名</summary>
        [XmlIgnore]
        public String memberName { get { return member != null ? member.nickName : null; } }

        [NonSerialized]
        private product _product;
        /// <summary>该couponshare所对应的product</summary>
        [XmlIgnore]
        ...
        public static couponshare FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<couponshare> FindAllBymemberId(Int32 memberid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<couponshare> FindAllByproductId(Int32 productid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<couponshare> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
